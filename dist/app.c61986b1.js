...
var CREATE_CLAIM = function CREATE_CLAIM(name, amount) {
  return {
    type: 'CREATE_CLAIM',
    Payload: {
      name: name,
...
var claims = function claims(listofclaims, action) {
  if (listofclaims === void 0) {
    listofclaims = [];
  }
  if (action.type === 'CREATE_CLAIM') {
    return __spreadArray(__spreadArray([], listofclaims, true), [action.Payload.name], false);
  }
  return listofclaims;
};
var accounting = function accounting(accountBal, action) {
  if (accountBal === void 0) {
    accountBal = 100;
  }
...
var policies = function policies(listofpolicies, action) {
  if (listofpolicies === void 0) {
    listofpolicies = [];
  }
  if (action.type == 'CREATE_POLICY') {
    return __spreadArray(__spreadArray([], listofpolicies, true), [action.Payload.name], false);
  }
